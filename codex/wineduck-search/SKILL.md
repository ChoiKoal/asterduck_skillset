...
description: Search and explore wines on WineDuck — wine search, autocomplete, country/region/appellation browsing. Trigger when user wants to find wine, explore wine regions, or look up wine information. No authentication required.
---
